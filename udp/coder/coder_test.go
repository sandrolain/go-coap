...
func testUnmarshalMessageError(t *testing.T, msg message.Message, buf []byte, expectedErr error) {
	t.Helper()
	_, err := DefaultCoder.Decode(buf, &msg)
...
func TestUnmarshalMessage(t *testing.T) {
	// RFC 7252 §3: payload marker (0xFF) MUST be followed by at least one byte;
	// a lone 0xFF with no payload is a message format error.
	testUnmarshalMessageError(t, message.Message{Options: make(message.Options, 0, 32)},
		[]byte{88, 128, 107, 170, 134, 237, 158, 132, 150, 19, 19, 159, 72, 20, 210, 14, 23, 231, 160, 183, 145, 128, 177, 14, 82, 20, 210, 255},
		ErrLonePayloadMarker,
	)
